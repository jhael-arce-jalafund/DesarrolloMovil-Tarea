...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btnMemoryClear: Button
    private lateinit var btnMemoryRecall: Button
    private lateinit var btnMemoryAdd: Button
    private lateinit var btnMemorySubtract: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnMemorySubtract = findViewById(R.id.btnMemorySubtract)
        setupEventListeners()
    }
    ...
    private fun setupEventListeners() {
        ...
        btnMemoryClear.setOnClickListener { memoryClear() }
        btnMemoryRecall.setOnClickListener { memoryRecall() }
        btnMemoryAdd.setOnClickListener { memoryAdd() }
        btnMemorySubtract.setOnClickListener { memorySubtract() }
    }

    // Funciones para las operaciones de memoria
    ...
    private fun memoryAdd() {
        if (result.isNotEmpty()) {
            memoryValue += result.toInt()
            result = ""
            Toast.makeText(this, "Valor añadido a memoria", Toast.LENGTH_SHORT).show()
            reloadScreen()
        }
    }
    ...
    private fun memorySubtract() {
        if (result.isNotEmpty()) {
            memoryValue -= result.toInt()
            result = ""
            Toast.makeText(this, "Valor restado de memoria", Toast.LENGTH_SHORT).show()
            reloadScreen()
        }
    }
